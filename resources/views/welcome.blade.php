...
<body class="bg-gray-100">
    ...
    <div class="bg-white">
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">Quick Quiz</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="quiz.php">Quiz Template</a>
                        </li>

                    </ul>
                    <a class="nav-link active p-2" aria-current="page" href="{{ Route('login') }}">Login</a>
                    <a class="nav-link active  p-2" aria-current="page" href="{{ Route('register') }}">Register</a>
                </div>
            </div>
        </nav>
            ...
            <div class="mx-auto max-w-2xl py-32 ">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        ...
                        Make Quiz fast <a href="login.php" class="font-semibold text-indigo-600"><span
                                class="absolute inset-0" aria-hidden="true"></span>Read more <span
                                aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Create an awesome quiz in
                        minutes</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">It is the easiest way to make quizzes Choose your
                        best plan</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="login.php"
                            class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                            started</a>
                        <a href="pricing.php" class="text-sm font-semibold leading-6 text-gray-900">Make Plan <span
    ...
    <div class="bg-white" style="margin-bottom:20px;">
        <div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
            <div class="max-w-2xl">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Meet our Intelectual Member</h2>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="h-16 w-16 rounded-full"
                            ...
                            alt="">
                        <div>
                            <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Member 01</h3>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="h-16 w-16 rounded-full"
                            ...
                            alt="">
                        <div>
                            <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Member 02</h3>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="h-16 w-16 rounded-full"
                            ...
                            alt="">
                        <div>
                            <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Member 03</h3>
                            <p class="text-sm font-semibold leading-6 text-indigo-600">Manager</p>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="h-16 w-16 rounded-full"
                            ...
                            alt="">
                        <div>
                            <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Member 04</h3>
